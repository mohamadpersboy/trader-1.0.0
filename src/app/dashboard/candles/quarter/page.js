...
const ENDPOINT = "/api/dashboard/candles/quarter";


export default function QuarterCandlesPage() {
                ...
                actions={
                    <>
                        ...
                        <ClearButton
                            endpoint={ENDPOINT}
                            label="Clear all"
                            warningText="This deletes every quarter candle AND its derived quarter CHOCH. This cannot be undone."
