...
const ENDPOINT = "/api/dashboard/chochs/quarter";


export default function QuarterChochPage() {
    ...
    return (
        <div>
            ...
            <PageHeader
                title="15 Minute CHOCH"
                description="Change of Character points detected on 15-minute candles"
                actions={
                    <>
                        <RefreshControls
                        ...
                        <ClearButton
                            endpoint={ENDPOINT}
                            label="Clear all"
                            warningText="This deletes every quarter CHOCH. This cannot be undone."
